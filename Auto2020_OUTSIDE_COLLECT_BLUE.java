...
@Autonomous(name= "Blue Outside")
public class Auto2020_OUTSIDE_COLLECT_BLUE extends LinearOpMode {
    //camera variables
    ...
    public void runOpMode() {
        ...
        Trajectory initialShot = drive.trajectoryBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(-50.0,51.54,Math.atan2((36 - 51.54), (74 + 50.0))+shootAngleOffsetRadians+Math.toRadians(3)))
                .build();
        /*
        Trajectory initialShot = drive.trajectoryBuilder(drive.getPoseEstimate())
        ...
        Trajectory collect3 = drive.trajectoryBuilder(initialShot.end())
                ...
                .addSpatialMarker(new Vector2d(-24.0,45.0), new MarkerCallback() {
                    @Override
                ...
                .splineToSplineHeading(new Pose2d(-32.0, 52.0, Math.atan2((36 - 52), (74 + 28))+shootAngleOffsetRadians+Math.toRadians(5)), Math.toRadians(180))
                .build();

        Trajectory collectLastAndShoot = drive.trajectoryBuilder(collect3.end())
                .splineToSplineHeading(new Pose2d(-6.0,58.0, Math.atan2((36 - 52.0), (74+10))+shootAngleOffsetRadians+Math.toRadians(-7)), 0.0)
                .build();

        Trajectory dumpWobble4 = drive.trajectoryBuilder(collectLastAndShoot.end())
                .splineToSplineHeading(new Pose2d(44.0,60, Math.toRadians(05.0)), Math.toRadians(0.0))
                .addSpatialMarker(new Vector2d(36.0,60.0), new MarkerCallback() {
                    @Override
                    public void onMarkerReached() {
        ...
        Trajectory park4 = drive.trajectoryBuilder(dumpWobble4.end(), true)
                ...
                .build();
        /*
        Trajectory dumpWobble4 = drive.trajectoryBuilder(initialShot.end())
                .splineToSplineHeading(new Pose2d(50.0,36, Math.toRadians(90.0)), Math.toRadians(0.0))
                .addSpatialMarker(new Vector2d(36.0,36.0), new MarkerCallback() {
                    @Override
                    public void onMarkerReached() {
                        robot.wobbleMotor.setTargetPosition(wobblePickUp);
                    }
        ...
        */
        ...
        Trajectory collect1AndShoot = drive.trajectoryBuilder(initialShot.end())
                ...
                .splineToSplineHeading(new Pose2d(-28.0,36.0, Math.toRadians(90.0)),Math.toRadians(90))
                .splineToConstantHeading(new Vector2d(-28.0, 45.0), Math.toRadians(90.0))
                .splineToSplineHeading(new Pose2d(-10.0,52.0, Math.atan2((36 - 52.0), (74+10))+shootAngleOffsetRadians+Math.toRadians(1.5)), 0.0)
                .build();
        ...
        Trajectory park1 = drive.trajectoryBuilder(dumpWobble1.end(), true)
                .splineToConstantHeading(new Vector2d(12.0,60.0), Math.toRadians(180))
                .build();
        ...
        robot.shooter.setVelocity(1630);
        robot.shooter2.setVelocity(1630);
        sleep(200);
        if(Ring != null) {
            if (Ring.center.x < 85) {
                Ring = null;
        ...
        switch(ringState)
        {
            case 0:
                ...
                while(opModeIsActive() && robot.shooter.getVelocity()<(1630 - 21) && robot.shooter.getVelocity()>(1630 + 21))
                {
                    robot.shooter.setVelocity(1630);
                    robot.shooter2.setVelocity(1630);
                }
            ...
            case 4:
                ...
                robot.pusher.setPosition(0.08);
                robot.intake.setPower(1);
                robot.shooter.setVelocity(1580);
                robot.shooter2.setVelocity(1580);
                drive.followTrajectory(collect3);
                robot.intake.setPower(1);
                sleep(900);
                while(opModeIsActive() && robot.shooter.getVelocity()<(1580 - 21) && robot.shooter.getVelocity()>(1580 + 21))
                {
                    robot.shooter.setVelocity(1580);
                    robot.shooter2.setVelocity(1580);
                }
