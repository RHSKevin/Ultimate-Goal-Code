...
@Autonomous(name= "Blue Inside")
public class Auto2020_INSIDE_COLLECT_BLUE extends LinearOpMode {
    //camera variables
    ...
    public void runOpMode() {
        ...
        Trajectory initialShot = drive.trajectoryBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(-50.0,24,Math.atan2((36 - 24), (74 + 50.0))+shootAngleOffsetRadians+Math.toRadians(1.5)))
                .build();
        ...
        Trajectory collect3_2 = drive.trajectoryBuilder(collect3.end())
                .splineToSplineHeading(new Pose2d(-29, 33, Math.atan2(36 - 33, 74+24)+shootAngleOffsetRadians+Math.toRadians(-3)), Math.toRadians(180.0))
                .build();

        Trajectory collectLastAndShoot = drive.trajectoryBuilder(collect3_2.end())
                .splineToSplineHeading(new Pose2d(-6.0,36.0, Math.atan2((0),(74+6))+shootAngleOffsetRadians+Math.toRadians(2)), 0.0)
                .build();

        Trajectory dumpWobble4 = drive.trajectoryBuilder(collectLastAndShoot.end())
                .splineToSplineHeading(new Pose2d(54.0,48.0, Math.toRadians(90.0)), Math.toRadians(25.0))
        ...
        Trajectory collect1AndShoot = drive.trajectoryBuilder(initialShot.end())
                ...
                .splineToSplineHeading(new Pose2d(-6.0,36.0, Math.atan2((36 - 36.0), (74+6))+shootAngleOffsetRadians+Math.toRadians(3)), 0.0)
                .build();

        Trajectory dumpWobble1 = drive.trajectoryBuilder(collect1AndShoot.end())
                .splineToSplineHeading(new Pose2d(20.0, 40.0, 0.0), 0.0)
        ...
        Trajectory park1 = drive.trajectoryBuilder(dumpWobble1.end())
                .addDisplacementMarker(5, new MarkerCallback() {
                    @Override
                    public void onMarkerReached() {
                        robot.wobbleMotor.setTargetPosition(wobbleRaise);
                ...
                .back(5)
                .splineToConstantHeading(new Vector2d(12.0,12.0), Math.toRadians(0))
                .build();
        ...
        Trajectory dumpWobble0 = drive.trajectoryBuilder(initialShot.end())
                .splineToSplineHeading(new Pose2d(12.0,44.0, Math.toRadians(95.0)), Math.toRadians(0.0))
        ...
        robot.shooter.setVelocity(1590);
        robot.shooter2.setVelocity(1590);
        sleep(200);
        if(Ring != null) {
            if (Ring.center.x < 85) {
                Ring = null;
        ...
        switch(ringState)
        {
            case 0:
                ...
                while(opModeIsActive() && robot.shooter.getVelocity()<(1590 - 21) && robot.shooter.getVelocity()>(1590 + 21))
                {
                    robot.shooter.setVelocity(1590);
                    robot.shooter2.setVelocity(1590);
                }
            ...
            case 1:
                ...
                sleep(150);
                robot.pusher.setPosition(0.08);
                robot.shooter.setVelocity(1540);
                robot.shooter2.setVelocity(1540);
                robot.intake.setPower(1);
                drive.followTrajectory(collect1AndShoot);
                sleep(350);
                while(opModeIsActive() && robot.shooter.getVelocity()<(1540 - 21) && robot.shooter.getVelocity()>(1540 + 21))
                {
                    robot.shooter.setVelocity(1540);
                    robot.shooter2.setVelocity(1540);
                }
            ...
            case 4:
                ...
                robot.pusher.setPosition(0.08);
                robot.intake.setPower(1);
                robot.shooter.setVelocity(1520);
                robot.shooter2.setVelocity(1520);
                drive.followTrajectory(collect3);
                drive.followTrajectory(collect3_2);
                robot.intake.setPower(1);
                sleep(700);
                while(opModeIsActive() && robot.shooter.getVelocity()<(1520 - 21) && robot.shooter.getVelocity()>(1520 + 21))
                {
                    robot.shooter.setVelocity(1520);
                    robot.shooter2.setVelocity(1520);
                }
    ...
    static class RingDetectionPipeline extends OpenCvPipeline
    {
        ...
        void analyzeContour(MatOfPoint contour, Mat input)
        {
            ...
            if (rotatedRectFitToContour.size.area() >= 200 && rotatedRectFitToContour.center.x > 80 && rotatedRectFitToContour.center.x < 130 && rotatedRectFitToContour.center.y > 130 && rotatedRectFitToContour.center.y < 280) {
